...
This is a basic example of zero truncated poisson model and zelterman model with 
data on immigration in netherlands with analytic variance:
...
`singleRcapture` also includes bootstraps and models truncated at values 0 and 1 
and non standard confidence levels (i.e. different from usual 95%)

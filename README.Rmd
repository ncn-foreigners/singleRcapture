...
`singleRcapture` package also includes the option to estimate standard error of
population size estimate by bootstrap and common non standard argument such
as significance levels different from usual 5%:
...
and for models with more than one distribution parameter we allow all parameters
to be covariate dependent for exapmle if we wish to modify the model above:
